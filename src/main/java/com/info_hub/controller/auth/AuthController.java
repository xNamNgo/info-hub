package com.info_hub.controller.auth;
...
public class AuthController {
    ...
    public ResponseEntity<MessageResponse> register(@Valid @RequestBody UserRegisterDTO userRegisterDTO, BindingResult result) {
